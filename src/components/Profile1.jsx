  ...
  return (
    <div>
      ...
      <div className='flex gap-10 flex-wrap'>
          <div className='mt-0 md:mt-20 mx-5 md:mx-0 p-10 md:p-20 md:h-[700px] w-[800px] md:w-[400px] lg:w-[600px] text-slate-900 border rounded-xl shadow-2xl h-auto flex flex-col gap-5 items-center md:items-start'>
            <div>
              {user.photo ? 
          ...
          <div className='rounded-xl shadow-2xl mx-5 md:mx-0 h-auto md:h-[700px] w-[800px] md:w-[400px] lg:w-[600px] mt-0 md:mt-20 border p-10'>
            <Box
              as="form"
